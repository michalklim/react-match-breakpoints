...
var BreakpointsStore = function () {
    function BreakpointsStore() {
        _classCallCheck(this, BreakpointsStore);
    }

    _createClass(BreakpointsStore, [{
        key: 'buildBreakpointsComponents',
        value: function buildBreakpointsComponents(breakpoints, componentRenameFn) {
            var _this = this;

            Object.keys(breakpoints).forEach(function (breakpoint) {
                var componentName = componentRenameFn ? componentRenameFn(breakpoint) : (0, _utils.capitalizeFirstLetter)(breakpoint);
                _this[componentName] = (0, _withBreakpoints2.default)(function (_ref) {
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.buildBooleanBreakpointsState = function (matchMediaBreakpoints) {
        return Object.keys(matchMediaBreakpoints).reduce(function (acc, breakpoint) {
            acc[breakpoint] = matchMediaBreakpoints[breakpoint].matches;
            return acc;
        }, {});
    };

    this.buildMatchMediaBreakpoints = function (breakpoints) {
        return Object.keys(breakpoints).reduce(function (acc, breakpoint) {
            acc[breakpoint] = window.matchMedia(breakpoints[breakpoint]);
            acc[breakpoint].addListener(function (mq) {
                mq.matches ? _this2.setActiveBreakpoint(breakpoint) : _this2.unsetActiveBreakpoint(breakpoint);
            });
            return acc;
        }, {});
    };
    ...
    this.setActiveBreakpoint = function (breakpoint) {
        _this2.setState(_defineProperty({}, breakpoint, true));
    };

    this.unsetActiveBreakpoint = function (breakpoint) {
        _this2.setState(_defineProperty({}, breakpoint, false));
    };
};
